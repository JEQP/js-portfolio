...
//         switch (id) {
//             case "portfolio":
//                 imageChosen.innerHTML = `<img src="./assets/images/atfirstbutthendone.jpg" class="rounded float-left zoom img-fluid" alt="At first but then"></a>`;
//                 title.innerHTML = `<h2>Portfolio</h2>`;
//                 dLink.innerHTML = `<a href="https://jeqp.github.io/portfolio/portfolio.html" target="_blank">Deployed Link</a>`;
//                 ghRepo.innerHTML = `<a href="https://github.com/JEQP/portfolio" target="_blank">GitHub Repo</a>`;
//                 description.innerHTML = `<p>A portfolio showcasing some of the content I have created. Styled with Bootstrap and using "Trade Wind" font from Google Fonts. An external Javascript file is used to change the showcased content based on the users' clicks.</p>`;
//                 break;

//             case "mixerupper":
//                 console.log("mixerupper run");
//                 console.log("imageChose: " + imageChosen.innerHTML);
//                 imageChosen.innerHTML = `<img src="./assets/images/mixeruppersquare.jpg" class="rounded float-left zoom img-fluid" alt="Mixer Upper">`;
//                 title.innerHTML = `<h2>Mixer Upper</h2>`;
//                 dLink.innerHTML = `<a href="https://jeqp.github.io/mixer-upper/index.html" target="_blank">Deployed Link</a>`;
//                 ghRepo.innerHTML = `<a href="https://github.com/JEQP/mixer-upper" target="_blank">GitHub Repo</a>`;
...
//             case "empTrack":
//                 console.log("empTrack");
//                 imageChosen.innerHTML = `<img src="./assets/images/employeetracker.jpg" class="rounded float-left zoom img-fluid" alt="Mixer Upper">`;
//                 title.innerHTML = `<h2>Employee Tracker CMS</h2>`;
//                 dLink.innerHTML = `<a href="https://github.com/JEQP/Employee_Tracker" target="_blank">CLI program</a>`;
//                 ghRepo.innerHTML = `<a href="https://github.com/JEQP/Employee_Tracker" target="_blank">GitHub Repo</a>`;
//                 description.innerHTML = `<p>This is a command line interface to allow users to interact with an employee database to view, create and update files. In the initial screen users choose to add, view, update a file, or leave the system. Uses Node.js and MySQL.</p>`;
